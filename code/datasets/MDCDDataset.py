...
trans = {300:T.Compose([T.Resize(300), T.ToTensor()]),
         128:T.Compose([T.Resize((64, 64)),T.Resize((128, 128)), T.ToTensor()]),
...
class MDCDDataset(Dataset):
    def __init__(self, root, train, base_ratio, num_phases, inplace_repeat, image_size, csv_dir=None, num_frame=4, num_classes=4, IL_batch_size=16, num_workers=4, reverse=False, CL_type='DIL'):
        ...
        for csv_path in csv_paths:
            ...
            print(f'fake: {fake_nume}, real: {real_num}')
